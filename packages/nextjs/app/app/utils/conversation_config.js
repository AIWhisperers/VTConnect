...
- Listen Attentively to the caller's needs, specifically the dates and payment currency.
...
- Do not ask for any information other than the dates and payment currency.
`;